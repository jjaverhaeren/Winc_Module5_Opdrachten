const ratings = [
  ...
  export const getDataSet = () => {
    ...
    distinctOpdrachtNames.forEach(name => {
      const [moeilijkArrayOfStudents, leukArrayOfStudents] = getAveragesPerOpdracht(name);
      moeilijkArrayOfStudents.forEach(data => {
        dataSet1Data.push(data);
      });
      leukArrayOfStudents.forEach(data => {
        dataSet2Data.push(data);
      });
    });
    return [ dataSet1Data, dataSet2Data ]
  };
